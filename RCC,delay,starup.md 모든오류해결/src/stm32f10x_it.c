...
* Return         : None
*******************************************************************************/
extern unsigned int timerCnt, timerCnt2;
extern unsigned char timer2msecFlag,timer100msecFlag;
...
/*
   ...
   if(USART_GetITStatus(USART1, USART_IT_RXNE) != RESET)
   {
		...
		SetPwmDuty(1,RX_Buffer[data]); SetPwmDuty(2,RX_Buffer[data]);

		Usart_Putnum(TIM_GetCounter(TIM4));
		Usart_Putnum(TIM_GetCounter(TIM3));
