...
/**
  * @brief  Enables or disables the USART뭩 DMA interface.
  * @param  USARTx: Select the USART or the UART peripheral. 
  *   This parameter can be one of the following values:
  *   USART1, USART2, USART3, UART4 or UART5.
...
/**
  * @brief  Enables or disables the USART뭩 LIN mode.
  * @param  USARTx: Select the USART or the UART peripheral. 
  *   This parameter can be one of the following values:
  *   USART1, USART2, USART3, UART4 or UART5.
...
void SerialPutChar3(uint16_t c)
{
  USART_SendData(USART3,c);
  while(USART_GetFlagStatus(USART3,USART_FLAG_TXE)==RESET);
}

void USART_SendStr1(unsigned char *str) {
	while (*str) SerialPutChar(*str++);
}

void USART_SendStr3(unsigned char *str) {
	while (*str) SerialPutChar3(*str++);
}
...
/**
  * @brief  Enables or disables the USART뭩 Smart Card mode.
  * @param  USARTx: where x can be 1, 2 or 3 to select the USART peripheral.
...
/**
  * @brief  Enables or disables the USART뭩 Half Duplex communication.
  * @param  USARTx: Select the USART or the UART peripheral. 
  *   This parameter can be one of the following values:
  *   USART1, USART2, USART3, UART4 or UART5.
